function getSwalTheme() {
    ...
    if (savedTheme === 'dark') {
        return {
            ...
            confirmButtonColor: '#dc3545', // Color rojo para el botón y el ícono en modo oscuro
        };
    }
    return {
        background: '#ffffff', // Fondo claro
        color: '#000000', // Texto negro
        confirmButtonColor: '#dc3545', // Color rojo para el botón y el ícono en modo claro
    };
}
